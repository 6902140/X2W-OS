...
.L31:
	...
	.loc 4 380 50
	bgeu	a4,a5,.L32
	.loc 4 380 50 is_stmt 0 discriminator 1
	ld	a5,40(sp)
	j	.L34
.L32:
	.loc 4 380 50 discriminator 2
	ld	a5,16(sp)
.L34:
	.loc 4 381 1 is_stmt 1 discriminator 5
	mv	a0,a5
	addi	sp,sp,48
	.cfi_def_cfa_offset 0
	jr	ra
...
.LC25:
	...
	.align	3
.LC26:
	.string	"\tmapping total free mem, %#X~%#X, %7d Bytes, %2d Pages used (%2d * 4096 = %7d)\n"
	.text
	.align	2
...
.LBB5:
	...
	.loc 5 162 76
	bne	a4,a5,.L42
	.loc 5 162 76 is_stmt 0 discriminator 1
	ld	a5,16(sp)
	ld	a5,16(a5)
	j	.L43
.L42:
	.loc 5 162 76 discriminator 2
	ld	a5,16(sp)
	ld	a5,24(a5)
.L43:
	.loc 5 162 21 is_stmt 1 discriminator 4
	sd	a5,32(sp)
	.loc 5 163 12 discriminator 4
	ld	a5,32(sp)
	beq	a5,zero,.L44
	.loc 5 164 13
	ld	a1,32(sp)
...
.L44:
.LBE5:
	.loc 5 161 31 discriminator 2
	lw	a5,44(sp)
	addiw	a5,a5,1
	sw	a5,44(sp)
	.loc 5 161 39 discriminator 2
	ld	a5,16(sp)
	addi	a5,a5,32
	sd	a5,16(sp)
.L41:
	.loc 5 161 23 discriminator 1
	lw	a5,44(sp)
	ld	a4,8(sp)
	bgtu	a4,a5,.L45
.LBE4:
...
.L49:
	...
	call	kprintf
.L48:
	.loc 5 175 94 discriminator 2
	lw	a5,68(sp)
	addiw	a5,a5,1
	sw	a5,68(sp)
.L47:
	.loc 5 175 23 discriminator 1
	lw	a5,68(sp)
	sext.w	a5,a5
	beq	a5,zero,.L49
.LBE6:
...
.L52:
	...
	.loc 5 191 28
	bne	a5,zero,.L53
	.loc 5 191 41 discriminator 1
	lbu	a5,41(sp)
	.loc 5 191 28 discriminator 1
	bne	a5,zero,.L54
.L53:
	.loc 5 203 33
	ld	a5,72(sp)
...
.L58:
	...
	.loc 5 222 20 discriminator 1
	ld	a5,48(sp)
	addi	a5,a5,8
	sd	a5,48(sp)
	.loc 5 222 35 discriminator 1
	ld	a4,56(sp)
	li	a5,4096
	add	a5,a4,a5
	sd	a5,56(sp)
	.loc 5 222 14 discriminator 1
	ld	a4,56(sp)
	ld	a5,40(sp)
	bltu	a4,a5,.L58
	.loc 5 223 1
...
.L69:
	...
	.loc 5 252 12
	beq	a5,zero,.L65
	.loc 5 252 45 discriminator 1
	ld	a5,48(sp)
	ld	a5,0(a5)
	mv	a0,a5
	call	is_leaf_page
	mv	a5,a0
	.loc 5 252 42 discriminator 1
	beq	a5,zero,.L66
.L65:
	.loc 5 254 13
	ld	a5,48(sp)
...
.LBB8:
	...
	j	.L73
.L74:
	.loc 5 272 29 discriminator 3
	lla	a4,pg_levels
	lw	a5,60(sp)
	slli	a5,a5,5
	add	a5,a4,a5
	ld	a4,8(a5)
	.loc 5 272 50 discriminator 3
	lla	a3,pg_levels
	lw	a5,60(sp)
	slli	a5,a5,5
	add	a5,a3,a5
	ld	a3,24(a5)
	.loc 5 272 60 discriminator 3
	lw	a5,56(sp)
	slli	a5,a5,5
	add	a5,a3,a5
	.loc 5 272 63 discriminator 3
	ld	a5,0(a5)
	.loc 5 272 35 discriminator 3
	or	a4,a4,a5
	lla	a3,pg_levels
	lw	a5,60(sp)
	slli	a5,a5,5
	add	a5,a3,a5
	sd	a4,8(a5)
	.loc 5 271 52 discriminator 3
	lw	a5,56(sp)
	addiw	a5,a5,1
	sw	a5,56(sp)
.L73:
	.loc 5 271 31 discriminator 1
	lw	a4,56(sp)
	.loc 5 271 45 discriminator 1
	lla	a3,pg_levels
	lw	a5,60(sp)
	slli	a5,a5,5
	add	a5,a3,a5
...
.L72:
.LBE8:
	.loc 5 269 82 discriminator 2
	lw	a5,60(sp)
	addiw	a5,a5,1
	sw	a5,60(sp)
.L71:
	.loc 5 269 23 discriminator 1
	lw	a5,60(sp)
	mv	a4,a5
	li	a5,2
	bleu	a4,a5,.L75
...
.LBE9:
	...
	sd	a5,88(sp)
.L78:
	.loc 5 307 9 discriminator 1
	ld	a2,8(sp)
	ld	a1,104(sp)
	ld	a0,88(sp)
	call	set_pt_entry
	.loc 5 310 20 discriminator 1
	ld	a4,104(sp)
	li	a5,4096
	add	a5,a4,a5
	sd	a5,104(sp)
	.loc 5 311 20 discriminator 1
	ld	a5,88(sp)
	addi	a5,a5,8
	sd	a5,88(sp)
	.loc 5 311 35 discriminator 1
	ld	a4,96(sp)
	li	a5,4096
	add	a5,a4,a5
	sd	a5,96(sp)
	.loc 5 311 14 discriminator 1
	ld	a4,96(sp)
	ld	a5,80(sp)
	bltu	a4,a5,.L78
	.loc 5 312 1
...
.LBE10:
	...
	sd	a5,88(sp)
.L81:
	.loc 5 343 22 discriminator 1
	li	a2,0
	ld	a1,80(sp)
	ld	a0,96(sp)
	call	get_mapping_end
	sd	a0,56(sp)
	.loc 5 345 9 discriminator 1
	ld	a5,0(sp)
	ld	a4,8(sp)
	ld	a3,104(sp)
	ld	a2,56(sp)
	...
	ld	a0,88(sp)
	call	make_pmd_entry
	.loc 5 347 35 discriminator 1
	ld	a4,56(sp)
	ld	a5,96(sp)
	sub	a5,a4,a5
	.loc 5 347 20 discriminator 1
	ld	a4,104(sp)
	add	a5,a4,a5
	sd	a5,104(sp)
	.loc 5 348 21 discriminator 1
	ld	a5,88(sp)
	addi	a5,a5,8
	sd	a5,88(sp)
	.loc 5 348 36 discriminator 1
	ld	a5,56(sp)
	sd	a5,96(sp)
	.loc 5 348 14 discriminator 1
	ld	a4,96(sp)
	ld	a5,80(sp)
	bltu	a4,a5,.L81
	.loc 5 349 1
...
.L83:
	...
	sd	a5,72(sp)
.L84:
	.loc 5 371 22 discriminator 1
	li	a2,1
	ld	a1,64(sp)
	ld	a0,80(sp)
	call	get_mapping_end
	sd	a0,56(sp)
	.loc 5 373 9 discriminator 1
	ld	a5,0(sp)
	ld	a4,8(sp)
	ld	a3,88(sp)
	ld	a2,56(sp)
	...
	ld	a0,72(sp)
	call	make_pgd_entry
	.loc 5 375 35 discriminator 1
	ld	a4,56(sp)
	ld	a5,80(sp)
	sub	a5,a4,a5
	.loc 5 375 20 discriminator 1
	ld	a4,88(sp)
	add	a5,a4,a5
	sd	a5,88(sp)
	.loc 5 376 21 discriminator 1
	ld	a5,72(sp)
	addi	a5,a5,8
	sd	a5,72(sp)
	.loc 5 376 36 discriminator 1
	ld	a5,56(sp)
	sd	a5,80(sp)
	.loc 5 376 14 discriminator 1
	ld	a4,80(sp)
	ld	a5,64(sp)
	bltu	a4,a5,.L84
	.loc 5 377 1
