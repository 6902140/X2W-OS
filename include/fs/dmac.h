...
typedef enum _dmac_src_dst_select { DMAC_SRC = 0x1, DMAC_DST = 0x2, DMAC_SRC_DST = 0x3 } dmac_src_dst_select_t;

typedef enum _state_value { clear = 0, set = 1 } state_value_t;

typedef enum _dmac_lock_bus_ch { DMAC_LOCK_BUS = 0x1, DMAC_LOCK_CHANNEL = 0x2, DMAC_LOCK_BUS_CH = 0x3 } dmac_lock_bus_ch_t;

typedef enum _dmac_sw_hw_hs_select { DMAC_HS_HARDWARE = 0x0, DMAC_HS_SOFTWARE = 0x1 } dmac_sw_hw_hs_select_t;

typedef enum _dmac_scatter_gather_param { DMAC_SG_COUNT = 0x0, DMAC_SG_INTERVAL = 0x1 } dmac_scatter_gather_param_t;
...
typedef enum _dmac_master_number { DMAC_MASTER1 = 0x0, DMAC_MASTER2 = 0x1 } dmac_master_number_t;
...
typedef enum _dmac_multiblk_transfer_type { CONTIGUOUS = 0, RELOAD = 1, SHADOWREGISTER = 2, LINKEDLIST = 3 } dmac_multiblk_transfer_type_t;
...
typedef enum _dmac_fifo_mode { DMAC_FIFO_MODE_SINGLE = 0x0, DMAC_FIFO_MODE_HALF = 0x1 } dmac_fifo_mode_t;

typedef enum _dw_dmac_flow_ctl_mode { DMAC_DATA_PREFETCH_ENABLED = 0x0, DMAC_DATA_PREFETCH_DISABLED = 0x1 } dw_dmac_flow_ctl_mode_t;

typedef enum _dmac_polarity_level { DMAC_ACTIVE_HIGH = 0x0, DMAC_ACTIVE_LOW = 0x1 } dmac_polarity_level_t;
